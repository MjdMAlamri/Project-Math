    ...
    <View style={styles.root}>
      ...
      <View style={styles.sidebar}>
        ...
        <View style={styles.brand}>
          ...
          <Text style={styles.brandText}>MathX</Text>
        </View>

        {/* Menu */}
      <View style={styles.menuList}>
        <SidebarItem active icon="grid-outline" label="Dashboard" href="/StudentD" />
        <SidebarItem icon="school-outline" label="Educational Mode" href="/educational" />
        ...
        <View style={styles.joinWrap}>
          <Pressable style={[styles.joinCard, shadow]}>
      ...
      <View style={styles.main}>
        ...
        <View style={[styles.topBar, shadow]}>
          ...
          <View style={styles.rightIcons}>
            ...
            <View style={styles.avatarWrap}>
              <Image
                source={{ uri: "https://i.pravatar.cc/64?img=13" }}
                style={styles.avatar}
              />
        ...
        <ScrollView
          style={{ flex: 1 }}
          contentContainerStyle={{ padding: S * 3 }}
...
const styles = StyleSheet.create({
  ...
  itemText: { color: "#E6ECFF", fontSize: 14, fontWeight: "600" },
